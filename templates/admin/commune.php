...
<div class="nav-scroller sub-context-nav">
    <nav class="nav nav-underline" aria-label="Secondary navigation">
        <a class="nav-link active" aria-current="page" href="#"><i class="bi-bank2"></i> Commune</a>
                        ...
                        <table class="options-tab-list table-bordernone">
                            ...
                            <tr>
                                ...
                                <td class="options-tab-list-col-title">
                                    <div class="title-box">
                                        <div class="menu-name f-18 bold">
                                            <span class="object">Commune</span>
                                                ...
                                                <div class="dijitTabListWrapper dijitTabContainerTopNone dijitAlignCenter" style="height: 41px; left: 39px; top: 0px; position: absolute; width: 88%;">
                                                    <div class="nowrapTabStrip dijitTabContainerTop-tabs" style="width: 51800px;">
                                                        ...
                                                        <div class="dijitTabInner dijitTabContent dijitTab" style="display: inline-block;">
                                                            <span class="tabLabel" style="user-select: none;" tabindex="-1" aria-disabled="false" title="">Fichier</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                            ...
                                                                            <table class="detail" style="width: 100%">
                                                                                    ...
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-box input required">
                                                                                            <div class="reset select-container">
                                                                                                <select id="select-type" class="reset input-select" name="select-type">
                                                                                ...
                                                                                <tr class="detail">
                                                                                    ...
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-box input">
                                                                                            <div class="reset input-container">
                                                                                                <input list="region-list" class="reset input-inner" id="input-region" name="input-region">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="detail">
                                                                                    ...
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-box input">
                                                                                            <div class="reset input-container">
                                                                                                <input list="department-list" class="reset input-inner" id="input-department" name="input-department">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="detail">
                                                                                    <td class="label" style="position: relative; width: 182px">
                                                                                        <label for="id">population</label>
                                                                                    </td>
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-box input">
                                                                                            <div class="reset input-container">
                                                                                                <input class="reset input-inner" id="input-population" name="input-population">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="detail">
                                                                                    <td class="label" colspan="2" style="position: relative;">
                                                                                        <div class="tab-label long-text-label" style="font-weight: normal; width: 13ex; text-align: center">
                                                                                            description
                                                                                        </div>
                                                                                        <div id="cke_description" class="cke_1 cke cke_reset cke_chrome cke_editor_description cke_ltr cke_browser_gecko">
                                                                                            <div class="cke_inner cke_reset">
                                                                                                <div class="cke_contents cke_reset" style="height: 186px">
                                                                                                    <textarea id="input-description" name="input-description"></textarea>
                                                                                                </div>
...
<datalist id="region-list">
    <option value="Extreme-Nord">Extr&ecirc;me-Nord</option>
...
<datalist id="department-list">
    ...
    <option value="Nfoundi">Nfoundi</option>
    <option value="Nyong-Ekelle">Nyong &Eacute;Ka&eacute;ll&eacute;</option>
</datalist>
...
<script>
    ...
    CKEDITOR.inline('input-description', {})
</script>
</body>
</html>
