                                                                            ...
                                                                            <table class="detail" style="width: 100%">
                                                                                ...
                                                                                <tr class="detail">
                                                                                    ...
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-box input">
                                                                                            <div class="reset input-container">
                                                                                                <input class="reset input-inner" id="input-matricule" name="input-matricule">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="detail">
                                                                                    ...
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-box input required">
                                                                                            <div class="reset input-container">
                                                                                                <input class="reset input-inner" id="input-username" name="input-username">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="detail pwrd">
                                                                                    <td class="label" style="position: relative; width: 182px">
                                                                                    ...
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-box input required">
                                                                                            <div class="reset input-container">
                                                                                                <input class="reset input-inner" id="input-password" name="input-password">
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="detail">
                                                                                    ...
                                                                                    <td style="width: 532px; height: 37px">
                                                                                        <div class="digit-text-bo inpu">
                                                                                            <div class="reset input-container">
                                                                                                <div class="form-check form-switch form-control-sm">
                                                                                                    <input class="form-check-input" type="checkbox" id="input-status" name="input-status">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
